...
/**
 * Provides services for managing enquiries related to BTO projects.
 * Handles submission, retrieval, viewing, responding to, and deleting enquiries,
 * including authorization checks based on user roles (Applicant, Officer, Manager).
 */
public class EnquiryService {
    ...
    /**
     * Submits a new enquiry for a specific project by an applicant.
     * Validates input and saves the enquiry using the repository.
     *
     ...
     * @return True if the enquiry was submitted successfully, false otherwise (e.g., invalid input).
     */
    ...
    /**
     * Retrieves all enquiries accessible to the current user.
     * Managers can see all enquiries.
     * Officers can see enquiries for projects they manage.
     * Includes authorization checks.
     *
     * @return A list of EnquiryModel objects accessible to the current user, or null if unauthorized or an error occurs.
     */
    ...
    /**
     * Displays the details of a specific enquiry, including its response if available.
     * Performs authorization checks: Managers can view any enquiry, Officers can view enquiries for their managed projects.
     * Prints the formatted enquiry details to the console.
     *
     * @param enquiryID The ID of the enquiry to view.
     * @return True if the enquiry was found and the user is authorized to view it, false otherwise.
     */
    ...
    /**
     * Adds or updates the response to a specific enquiry.
     * Performs authorization checks: Managers can respond to enquiries for projects they manage,
     * Officers can respond to enquiries for projects they manage.
     *
     * @param enquiryID The ID of the enquiry to respond to.
     * @param response The text content of the response.
     * @return True if the response was successfully added/updated, false otherwise (e.g., enquiry not found, unauthorized).
     */
