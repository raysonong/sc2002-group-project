 ...
 * This class provides basic user attributes and functionalities 
 */
public abstract class User {
    ...
    private int age;
     /**
     * The marital status, note that users will parse String "Married"/"Single" as params, ensure to handle it.
     */
     ...
     * @throws AuthenticationException If the NRIC or password does not match the stored credentials.
     */
